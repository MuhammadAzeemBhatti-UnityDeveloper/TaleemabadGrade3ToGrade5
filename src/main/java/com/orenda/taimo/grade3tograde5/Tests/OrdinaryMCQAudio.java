...
public class OrdinaryMCQAudio extends Fragment implements View.OnClickListener, View.OnTouchListener, View.OnDragListener {


    SharedPreferences sharedPrefs;
    SharedPreferences.Editor editor;
    MediaPlayer mediaPlayerTouch;
    ImageView play_sound_image1, play_sound_image2, play_sound_image3, play_sound_image4, answer_image_view;
    ...
    public OrdinaryMCQAudio(int testId, TestJsonParseModel test, Context context, Activity activity) {
        this.testId = testId;
        this.test = test;
        mContext = context;
        ...
        Log.wtf("-test", " TEST Audio 3  : " + test.getOptionList().get(2).getAudio());
        Log.wtf("-test", " TEST Audio 4  : " + test.getOptionList().get(3).getAudio());

    }

    public OrdinaryMCQAudio() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ordinary_mcqaudio, container, false);
    ...
    private void initializeViews(View view) {
        //playAssetSound(String.valueOf(test.getQuestion().getAudio()));
        ...
        play_sound_image3 = view.findViewById(R.id.play_sound_image3);
        play_sound_image4 = view.findViewById(R.id.play_sound_image4);
        ...
        image3 = play_sound_image3.getId();
        image4 = play_sound_image4.getId();


        ordinaryMCQMainLayout=view.findViewById(R.id.mainConstraintLayout);
        ...
        //To retrieve
//        SharedPreferences sharedPrefForChecking = getActivity().getSharedPreferences("DemoOrdinaryMCQAudio", DEMO_MODE);
//        ordinaryMCQ = sharedPrefForChecking.getBoolean("OrdinaryMCQAudio", false); //0 is the default value
...
/*
    public void startDemo(){
        ...
        String option1 = test.getOptionList().get(0).getText().toString();
        String option2 = test.getOptionList().get(1).getText().toString();
        String option3 = test.getOptionList().get(2).getText().toString();
        String option4 = test.getOptionList().get(3).getText().toString();
...
//        Log.wtf("-hello", "ans : " + anstext);
//        Log.wtf("-hello", "1 : " + option1  );
//        Log.wtf("-hello", "2 : " + option2  );
//        Log.wtf("-hello", "3 : " + option3  );
//        Log.wtf("-hello", "4 : " + option4  );
        ...
        if (option1.equals(anstext)){
            ...
            constraintSet.connect(handImageview.getId(), ConstraintSet.TOP, R.id.Image3Top,ConstraintSet.TOP,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.END, R.id.Image3Right,ConstraintSet.START,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.START, R.id.Image3Left,ConstraintSet.END,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.BOTTOM, R.id.Image3Bottom,ConstraintSet.TOP,10);
            constraintSet.applyTo(dragTextBoxToPictureTwoOptionsMainLayout);
            ...
            dragTextBoxToPictureTwoOptionsMainLayout.addView(handImageview);
            constraintSet.connect(handImageview.getId(), ConstraintSet.TOP, R.id.Image4Top,ConstraintSet.TOP,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.END, R.id.Image4Right,ConstraintSet.START,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.START, R.id.Image4Left,ConstraintSet.END,10);
            constraintSet.connect(handImageview.getId(),ConstraintSet.BOTTOM, R.id.Image4Bottom,ConstraintSet.TOP,10);
            constraintSet.applyTo(dragTextBoxToPictureTwoOptionsMainLayout);
...
/*
    ...
    */
    ...
    public void setOnClickListeners(View view) {
        ...
        play_sound_image3.setOnTouchListener(this);
        play_sound_image4.setOnTouchListener(this);
        ...
        switch (event.getAction()) {
            ...
            case DragEvent.ACTION_DROP:
                ...
                if (selectedView.getId() == play_sound_image1.getId() || selectedView.getId() == play_sound_image2.getId()
                        || selectedView.getId() == play_sound_image3.getId() || selectedView.getId() == play_sound_image4.getId()) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (selectedView.getId() == image1) {
               // playAssetSound(String.valueOf(test.getOptionList().get(0).getAudio()));
                ...
                //playAssetSound(String.valueOf(test.getOptionList().get(1).getAudio()));
                loadAudio(test.getOptionList().get(1).getAudio());
                answer = String.valueOf(test.getOptionList().get(1).getAudio());
            } else if (selectedView.getId() == image3) {
                //playAssetSound(String.valueOf(test.getOptionList().get(2).getAudio()));
                loadAudio(test.getOptionList().get(2).getAudio());
                answer = String.valueOf(test.getOptionList().get(2).getAudio());
            } else if (selectedView.getId() == image4) {
                //playAssetSound(String.valueOf(test.getOptionList().get(3).getAudio()));
                loadAudio(test.getOptionList().get(3).getAudio());
                answer = String.valueOf(test.getOptionList().get(3).getAudio());
            }
            ...
            public void run() {
                ...
                if(getFragmentManager() != null) {
                    getFragmentManager().beginTransaction()
                            .remove(OrdinaryMCQAudio.this).commit();
                }
