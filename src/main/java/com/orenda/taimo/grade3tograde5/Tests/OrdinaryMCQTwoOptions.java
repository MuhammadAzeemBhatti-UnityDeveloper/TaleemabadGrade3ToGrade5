...
public class OrdinaryMCQTwoOptions extends Fragment implements View.OnClickListener {

    SharedPreferences sharedPrefs;
    SharedPreferences.Editor editor;
    TextView ordinaryMCQTwoOptionsTextViewOption1, ordinaryMCQTwoOptionsTextViewOption2;
    TextView ordinaryMCQTwoOptionsTextViewQuestion;
...
//    int DEMO_MODE=0;
//    ConstraintLayout ordinaryMCQTwoOptionsMainLayout;
//    Boolean ordinaryMCQ;
//    MediaPlayer mp;
...
//    boolean stillInDemoState=false;
    ...
    public OrdinaryMCQTwoOptions(int testId, TestJsonParseModel test, Context context, Activity activity) {
        this.testId = testId;
        this.test = test;
        mContext = context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.ordinary_mcq_two_options, container, false);
    ...
    public void initializeView(View view) {
        ...
        ordinaryMCQTwoOptionsTextViewQuestion = view.findViewById(R.id.ordinaryMCQTwoOptionsTextViewQuestion);

        ordinaryMCQTwoOptionsTextViewOption1 = view.findViewById(R.id.ordinaryMCQTwoOptionsTextViewOption1);
        ordinaryMCQTwoOptionsTextViewOption2 = view.findViewById(R.id.ordinaryMCQTwoOptionsTextViewOption2);
...
//        ordinaryMCQTwoOptionsMainLayout =view.findViewById(R.id.ordinaryMCQTwoOptionsMainLayout);
        ...
        if (viewTreeObserver.isAlive()) {
            viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    Log.wtf("-this", "QUESTION SIZE : " + ordinaryMCQTwoOptionsTextViewQuestion.getText().toString().length());

                    ordinaryMCQTwoOptionsTextViewQuestion.setTextSize(questionFontSize);

                    ordinaryMCQTwoOptionsTextViewOption1.setTextSize(optionFontSize);
                    ordinaryMCQTwoOptionsTextViewOption2.setTextSize(optionFontSize);
...
/*
    public void startDemo() {
      ...
      //  mp.setLooping(true);
        ...
        ordinaryMCQTwoOptionsTextViewOption1.setVisibility(View.VISIBLE);
        ordinaryMCQTwoOptionsTextViewOption2.setVisibility(View.VISIBLE);


        String ansText  = test.getAnswerList().get(0).getText();

        String option1_Text =ordinaryMCQTwoOptionsTextViewOption1.getText().toString();
        String option2_Text =ordinaryMCQTwoOptionsTextViewOption2.getText().toString();


        final ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.clone(ordinaryMCQTwoOptionsMainLayout);
...
//                    jab();
                    ...
                    ordinaryMCQTwoOptionsMainLayout.addView(imageview);
...
//                    constraintSet.connect(imageview.getId(),ConstraintSet.END,R.id.guidelineOption1Right,ConstraintSet.START,10);
                    ...
                    constraintSet.applyTo(ordinaryMCQTwoOptionsMainLayout);
                    imageview.getLayoutParams().width  = ordinaryMCQTwoOptionsTextViewOption1.getMeasuredHeight()/2;
                    imageview.getLayoutParams().height = ordinaryMCQTwoOptionsTextViewOption1.getMeasuredHeight()/2;
...
//                    constraintSet.connect(imageview.getId(),ConstraintSet.END,R.id.guidelineOption2Right,ConstraintSet.START,10);
                    ...
                    constraintSet.connect(imageview.getId(),ConstraintSet.BOTTOM, R.id.guidelineOption1Bottom,ConstraintSet.TOP,10);
                    constraintSet.applyTo(ordinaryMCQTwoOptionsMainLayout);
                    imageview.getLayoutParams().width = ordinaryMCQTwoOptionsTextViewOption2.getMeasuredHeight()/2;
                    imageview.getLayoutParams().height = ordinaryMCQTwoOptionsTextViewOption2.getMeasuredHeight()/2;
                    imageview.bringToFront();
...
//                .translationY(50)
        ...
        if (icon==1){
            ordinaryMCQTwoOptionsTextViewOption1.animate()
//                .translationX(50)
//                .translationY(50)
                    .alpha(1.0f)
                    .scaleX(1f)
            ...
            ordinaryMCQTwoOptionsTextViewOption2.animate()
//                .translationX(50)
//                .translationY(50)
                    .alpha(1.0f)
                    .scaleX(1f)
 ...
 */
    ...
    public void showViews() {
        ...
        ordinaryMCQTwoOptionsTextViewQuestion.setVisibility(View.VISIBLE);
//        ordinaryMCQTwoOptionsTextViewOption1.setVisibility(View.VISIBLE);
//        ordinaryMCQTwoOptionsTextViewOption2.setVisibility(View.VISIBLE);
    ...
    public void setBackGrounds(String subject) {
        switch (subject) {
            case ("English"):
                ordinaryMCQTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.english_bg);
                ordinaryMCQTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.english_bg);


                break;
            case ("Maths"):
                ordinaryMCQTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.maths_bg);
                ordinaryMCQTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.maths_bg);
                break;

            case ("Urdu"):
                ordinaryMCQTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.urdu_bg);
                ordinaryMCQTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.urdu_bg);

                break;

            case ("GeneralKnowledge"):
            case ("Science"):
                ordinaryMCQTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.science_bg);
                ordinaryMCQTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.science_bg);
    ...
    public void fillUpTest() {
        generateRandom();
        ordinaryMCQTwoOptionsTextViewQuestion.setText(test.getQuestion().getText());
        ordinaryMCQTwoOptionsTextViewOption1.setText(test.getOptionList().get(arr[0]).getText());
        ordinaryMCQTwoOptionsTextViewOption2.setText(test.getOptionList().get(arr[1]).getText());

    }

    public void setOnClickListeners(View view) {

        ordinaryMCQTwoOptionsTextViewOption1.setOnClickListener(this);
        ordinaryMCQTwoOptionsTextViewOption2.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ordinaryMCQTwoOptionsTextViewOption1:
                ordinaryMCQTwoOptionsTextViewOption1.setOnClickListener(null);
                ordinaryMCQTwoOptionsTextViewOption2.setOnClickListener(null);
                String uidAudio = topic+"Question"+(tempIndex+1)+"Option"+(arr[0]+1)+"Audio.mp3";
                selectedTextView = ordinaryMCQTwoOptionsTextViewOption1;
                if (unSocratic == true) {
                    ...
                    compileAns(ordinaryMCQTwoOptionsTextViewOption1);
                }

                break;
            case R.id.ordinaryMCQTwoOptionsTextViewOption2:
                ordinaryMCQTwoOptionsTextViewOption1.setOnClickListener(null);
                ordinaryMCQTwoOptionsTextViewOption2.setOnClickListener(null);
                String uidAudio1 = topic+"Question"+(tempIndex+1)+"Option"+(arr[1]+1)+"Audio.mp3";
                selectedTextView = ordinaryMCQTwoOptionsTextViewOption2;
                if (unSocratic == true) {
                    // setAudioDescription(uidAudio, ordinaryMCQTextViewOption1);
                    File myDirectory = new File(getContext().getFilesDir(), "TestAudios");
                    ...
                    compileAns(ordinaryMCQTwoOptionsTextViewOption2);
                }
            ...
            public void run() {
                ...
                if(getFragmentManager() != null) {
                    getFragmentManager().beginTransaction()
                            .remove(OrdinaryMCQTwoOptions.this).commit();
                }
    ...
    public void setViews(){
        ordinaryMCQTwoOptionsTextViewOption1.setVisibility(View.INVISIBLE);
        ordinaryMCQTwoOptionsTextViewOption2.setVisibility(View.INVISIBLE);
