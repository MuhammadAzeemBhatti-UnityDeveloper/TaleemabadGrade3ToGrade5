...
public class LabellingTwoOptions extends Fragment implements View.OnClickListener, View.OnTouchListener, View.OnDragListener {
    ...
    TextView labellingTwoOptionsTextViewOption1, labellingTwoOptionsTextViewOption2,
            labellingTwoOptionsTextViewAnswer1, labellingTwoOptionsTextViewAnswer2;

    TextView labellingTwoOptionsTextViewQuestion;
    ImageView labellingTwoOptionsImageViewQuestion;
    ...
    /*int DEMO_MODE=0;
    ConstraintLayout labellingTwoOptionsMainLayout;
    int  labellingTwoOptionsXCoordinate,  labellingTwoOptionsYCoordinate;
    ...
    public LabellingTwoOptions(int testId, TestJsonParseModel test, Context context, Activity activity) {
        this.testId = testId;
        this.test = test;
        mContext = context;
    ...
    public LabellingTwoOptions() {
    }


    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.labelling_two_options, container, false);
    ...
    public void initializeView(View view) {
        ...
        labellingTwoOptionsTextViewQuestion = view.findViewById(R.id.labellingTwoOptionsTextViewQuestion);
        labellingTwoOptionsImageViewQuestion = view.findViewById(R.id.labellingTwoOptionsImageViewQuestion);
        labellingTwoOptionsTextViewOption1 = view.findViewById(R.id.labellingTwoOptionsTextViewOption1);
        labellingTwoOptionsTextViewOption2 = view.findViewById(R.id.labellingTwoOptionsTextViewOption2);

        labellingTwoOptionsTextViewAnswer1 = view.findViewById(R.id.labellingTwoOptionsTextViewAnswer1);
        labellingTwoOptionsTextViewAnswer2 = view.findViewById(R.id.labellingTwoOptionsTextViewAnswer2);
        ...
        //labellingTwoOptionsMainLayout = view.findViewById(R.id.labellingTwoOptionsMainLayout);
        ...
        if (viewTreeObserver.isAlive()) {
            viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    Log.wtf("-this", "QUESTION SIZE : " + labellingTwoOptionsTextViewQuestion.getText().toString().length());

                    labellingTwoOptionsTextViewQuestion.setTextSize(fontSizeQuestion);

                    labellingTwoOptionsTextViewOption1.setTextSize(fontSize);
                    labellingTwoOptionsTextViewOption2.setTextSize(fontSize);

                    labellingTwoOptionsTextViewAnswer1.setTextSize(fontSize);
                    labellingTwoOptionsTextViewAnswer2.setTextSize(fontSize);
       ...
       // setOnClickListeners(view);
        ...
        //To retrieve
//        SharedPreferences sharedPrefForChecking = getActivity().getSharedPreferences("DemoLabellingTwoOptions", DEMO_MODE);
//        ordinaryMCQ = sharedPrefForChecking.getBoolean("DemoLabellingTwoOptions", false); //0 is the default value
...
//                    jab();
            ...
            SharedPreferences sharedPrefForSaving = getContext().getSharedPreferences("DemoLabellingTwoOptions", DEMO_MODE);
            SharedPreferences.Editor editor = sharedPrefForSaving.edit();
            editor.putBoolean("DemoLabellingTwoOptions", true);
            editor.apply();
...
*/
    ...
    public void startDemo(){
      ...
      //  mp.setLooping(true);
        ...
        String option1 = labellingTwoOptionsTextViewOption1.getText().toString();
        String option2 = labellingTwoOptionsTextViewOption2.getText().toString();

        final ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.clone(labellingTwoOptionsMainLayout);
        ...
        if (option1.equals(anstext)){
            labellingTwoOptionsMainLayout.addView(handImagview);
            ...
            constraintSet.applyTo(labellingTwoOptionsMainLayout);

            int[] location = new int[2];
            labellingTwoOptionsTextViewOption1.getLocationOnScreen(location);
            labellingTwoOptionsXCoordinate = location[0];
            labellingTwoOptionsYCoordinate = location[1];
            ...
            int[] location = new int[2];
            labellingTwoOptionsTextViewOption2.getLocationOnScreen(location);
            labellingTwoOptionsXCoordinate = location[0];
            labellingTwoOptionsYCoordinate = location[1];
...
*/
    ...
    public void moveto(final ImageView imageview){
        ...
        labellingTwoOptionsTextViewAnswer1.getLocationOnScreen(location1);
        final int movetoX = location1[0];
        final int movetoY = location1[1];


        if (whichOptionIsCorrect==1){
            labellingTwoOptionsTextViewOption1.bringToFront();
            labellingTwoOptionsTextViewOption1.animate()
                    .translationX(-50)
                    .alpha(0f)
                    .scaleX(1f)
                    .scaleY(1f)
            ...
            labellingTwoOptionsTextViewOption2.bringToFront();
            labellingTwoOptionsTextViewOption2.animate()
                    .translationX(-50)
                    .alpha(0f)
                    .scaleX(1f)
                    .scaleY(1f)
...
/*
    public void movetoback(final ImageView imageview){
        ...
        imageview.bringToFront();
        imageview.animate()
                .x(labellingTwoOptionsXCoordinate)
                .y(labellingTwoOptionsYCoordinate)
                .alpha(1f)
                .scaleX(1f)
                .scaleY(1f)
                .setDuration(500)
...
*/
    ...
    public void showViews() {
        ...
        labellingTwoOptionsTextViewQuestion.setVisibility(View.VISIBLE);
//        labellingTwoOptionsTextViewOption1.setVisibility(View.VISIBLE);
//        labellingTwoOptionsTextViewOption2.setVisibility(View.VISIBLE);
//
//        labellingTwoOptionsTextViewAnswer1.setVisibility(View.VISIBLE);
//        labellingTwoOptionsTextViewAnswer2.setVisibility(View.VISIBLE);

        labellingTwoOptionsImageViewQuestion.setVisibility(View.VISIBLE);
    ...
    public void setBackGrounds(String subject) {
        switch (subject) {
            case ("English"):
                labellingTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.english_bg);
                labellingTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.english_bg);

                break;
            case ("Maths"):
                labellingTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.maths_bg);
                labellingTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.maths_bg);
                break;

            case ("Urdu"):
                labellingTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.urdu_bg);
                labellingTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.urdu_bg);

                break;

            case ("GeneralKnowledge"):
            case ("Science"):
                labellingTwoOptionsTextViewOption1.setBackgroundResource(R.drawable.science_bg);
                labellingTwoOptionsTextViewOption2.setBackgroundResource(R.drawable.science_bg);
    ...
    public void fillUpTest() {
        labellingTwoOptionsTextViewQuestion.setText(test.getQuestion().getText());
        labellingTwoOptionsImageViewQuestion.setImageBitmap(getBitmapFromAsset(test.getQuestion().getImage()));
        generateRandom();
        labellingTwoOptionsTextViewOption1.setText(test.getOptionList().get(arr[0]).getText());
        labellingTwoOptionsTextViewOption2.setText(test.getOptionList().get(arr[1]).getText());
    ...
    public void setOnClickListeners(View view) {
        ...
        labellingTwoOptionsTextViewOption1.setOnTouchListener(this);
        labellingTwoOptionsTextViewOption2.setOnTouchListener(this);

        labellingTwoOptionsTextViewAnswer1.setOnDragListener(this);
        labellingTwoOptionsTextViewAnswer2.setOnDragListener(this);
    ...
    public boolean onDrag(View v, DragEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case DragEvent.ACTION_DROP:
                ...
                if (selectedView.getId() == labellingTwoOptionsTextViewOption1.getId() || selectedView.getId() == labellingTwoOptionsTextViewOption2.getId()) {

                    if (txtView.getId() == labellingTwoOptionsTextViewOption1.getId() || txtView.getId() == labellingTwoOptionsTextViewOption2.getId()) {
                        ...
                        answerCount++;
                        if(selectedView.getId() == labellingTwoOptionsTextViewOption1.getId()){
                        ...
                        } else if(selectedView.getId() == labellingTwoOptionsTextViewOption2.getId()){
    ...
    public void compileAns(){
        ...
        start = false;
        T.cancel();
        labellingTwoOptionsTextViewOption1.setOnTouchListener(null);
        labellingTwoOptionsTextViewOption2.setOnTouchListener(null);

        labellingTwoOptionsTextViewAnswer1.setOnDragListener(null);
        labellingTwoOptionsTextViewAnswer2.setOnDragListener(null);
        ...
        if(labellingTwoOptionsTextViewAnswer1.getText().toString().equalsIgnoreCase(test.getOptionList().get(0).getText())){
            if(unSocratic == true)
            appAnalytics.setOptionPlaced(selectedSubject,topic,test.getType(),labellingTwoOptionsTextViewAnswer1.getText().toString(),true);

            score = score + tScore;
            count++;
            labellingTwoOptionsTextViewAnswer1.setBackgroundResource(R.drawable.ordinary_mcq_option_bg_green);
        } else{
            if(unSocratic == true)
                appAnalytics.setOptionPlaced(selectedSubject, topic, test.getType(), labellingTwoOptionsTextViewAnswer1.getText().toString(), false);

            labellingTwoOptionsTextViewAnswer1.setBackgroundResource(R.drawable.ordinary_mcq_option_bg_red);
        }
        if(labellingTwoOptionsTextViewAnswer2.getText().toString().equalsIgnoreCase(test.getOptionList().get(1).getText())){
         //   appAnalytics.setOptionPlaced(selectedSubject,topic,test.getType(),labellingTwoOptionsTextViewAnswer2.getText().toString(),true);

            score = score + tScore;
            count++;
            labellingTwoOptionsTextViewAnswer2.setBackgroundResource(R.drawable.ordinary_mcq_option_bg_green);
        } else{
            if(unSocratic == true)
            appAnalytics.setOptionPlaced(selectedSubject,topic,test.getType(),labellingTwoOptionsTextViewAnswer2.getText().toString(),false);

            labellingTwoOptionsTextViewAnswer2.setBackgroundResource(R.drawable.ordinary_mcq_option_bg_red);
        }
            ...
            public void run() {
                ...
                if(getFragmentManager() != null) {
                    getFragmentManager().beginTransaction()
                            .remove(LabellingTwoOptions.this).commit();
                }
    ...
    public void setViews(){
        labellingTwoOptionsTextViewOption1.setVisibility(View.INVISIBLE);
        labellingTwoOptionsTextViewOption2.setVisibility(View.INVISIBLE);

        labellingTwoOptionsTextViewAnswer1.setVisibility(View.INVISIBLE);
        labellingTwoOptionsTextViewAnswer2.setVisibility(View.INVISIBLE);
